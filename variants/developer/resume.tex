...
\begin{document}
    ...
    \begin{cvsection}{Work Experience}
        \begin{cvsubsection}{Senior Software Engineer}{Cloudera, Santa Clara}{Feb 2024 - Present}
            \begin{itemize}
                \item Led end-to-end release activities for Apache Ranger 2.7 and 2.8 as release manager, coordinating across contributors and ensuring production readiness.
